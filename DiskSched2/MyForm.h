...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->initial = (gcnew System::Windows::Forms::TextBox());
			...
			chartArea1->AxisY->Title = L"Track number";
			chartArea1->AxisY->TitleFont = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.2F, System::Drawing::FontStyle::Regular,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			chartArea1->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(189)), static_cast<System::Int32>(static_cast<System::Byte>(205)),
				static_cast<System::Int32>(static_cast<System::Byte>(214)));
			chartArea1->BorderDashStyle = System::Windows::Forms::DataVisualization::Charting::ChartDashStyle::Solid;
			chartArea1->Name = L"ChartArea1";
			this->sched->ChartAreas->Add(chartArea1);
			this->sched->Cursor = System::Windows::Forms::Cursors::Default;
			legend1->Name = L"Legend1";
			this->sched->Legends->Add(legend1);
			...
			series1->Color = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(96)), static_cast<System::Int32>(static_cast<System::Byte>(150)),
			...
			this->sched->Series->Add(series1);
			this->sched->Series->Add(series2);
			this->sched->Series->Add(series3);
			...
			this->inputtracks->Location = System::Drawing::Point(88, 55);
			this->inputtracks->Margin = System::Windows::Forms::Padding(4);
			this->inputtracks->Name = L"inputtracks";
			this->inputtracks->Size = System::Drawing::Size(205, 30);
			...
			this->InputLabel->Location = System::Drawing::Point(88, 24);
			...
			this->main->Controls->Add(this->initial);
			...
			this->label4->Margin = System::Windows::Forms::Padding(4);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(56, 23);
			this->label4->TabIndex = 12;
			this->label4->Text = L"Initial:";
			// 
			// initial
			// 
			this->initial->BorderStyle = System::Windows::Forms::BorderStyle::FixedSingle;
			this->initial->Location = System::Drawing::Point(26, 55);
			this->initial->Margin = System::Windows::Forms::Padding(4);
			this->initial->Name = L"initial";
			this->initial->Size = System::Drawing::Size(54, 30);
			this->initial->TabIndex = 11;
			// 
			// MyForm
			// 
...
#pragma endregion
	private: System::Void submitbutton_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		else
		{
			...
			Yvalues->AddRange(stringtodouble(Initial));
			...
			{
				sched->ChartAreas[0]->AxisY->Maximum = Convert::ToDouble(maxtrack->Text) - 1;
			}
			else
			{
